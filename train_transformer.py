...
import numpy as np
from model import LSTM_Classifier, RNN_Classifier, MLP, TimeSeriesClassifier
...
# モデルのインスタンスを作成
model = TimeSeriesClassifier(input_dim=INPUT_DIM, num_classes=NUM_CLASSES, d_model=D_MODEL).to(device)
