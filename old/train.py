...
def objective(trial):
    ...
    lr = 1e-5#trial.suggest_float("lr", 1e-7, 1e-2, log=True)
    ...
    weight_decay = 1e-4#trial.suggest_float("weight_decay",1e-7, 1e-4, log=True)
    #hidden_dims = []
    ...
    DATA_DIR = 'dataset\\YSYW_seq\\spec_RRI_120-16-1'
    TRAIN_RATIO = 0.8
    # npyファイルのリストを取得
